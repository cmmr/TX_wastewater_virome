...
ggsave(movp, file = sprintf("%s/charts/important_pathogens_by_city1.pdf", find_rstudio_root_file()), width = 8, height = 5)
...
ggsave(sprintf("%s/charts/important_pathogen_heatmap.pdf", find_rstudio_root_file()), width = 11, height = 7)
