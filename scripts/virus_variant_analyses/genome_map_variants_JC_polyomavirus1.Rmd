---
title: "genome maps with non-synonmous mutations, JC Polyomavirus"
...
gene_table$molecule <- "JC Polyomavirus"
...
ggsave(w_legend_combp, file = sprintf("%s/charts/JC_polyomavirus_genomemap_mutations3.pdf", 
                            find_rstudio_root_file()), 
       width = 7, height = 5)
```
