...
variant_table=sprintf(
  "%s/data/all_JCPyV_genbank_J02226.1.nonsyn_variants.tsv", 
...
pal <- wes_palette("IsleofDogs1", 6, type = "continuous")
labels <- little_gene %>%
...
ggsave(pm_labs, file = sprintf("%s/charts/JCPyV_ggtree_heatmap2.pdf", find_rstudio_root_file()), width = 8, height = 6)
