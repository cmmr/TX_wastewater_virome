---
title: "Houston WWTP Service Areas"
output:
  html_notebook:
    toc: yes
date: "2023-03-16"
...
shp <- readOGR("WWTP", "WW_final", verbose=F)
...
Harris_Map <- ggmap(get_googlemap(center=Harris_center, scale=2 ,zoom=9, maptype = "roadmap"), extent="panel")
Harris_Map
